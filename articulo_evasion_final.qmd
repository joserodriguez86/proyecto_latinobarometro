...
latinobarometro2020 %>% 
  ...
  geom_axis_flags(breaks = latinobarometro$iso3,
                  ...
                  width = 20,
                  lineheight = 2) +
  labs(title = "Índice de estratificación objetiva",
...
ggsave("graficos/evasion/estratificacion_objetiva.png", width = 8, height = 5, dpi = 300)
...
latinobarometro %>% 
  ...
  labs(
    title = "Evolución del porcentaje de personas que pagaron menos impuestos del que debían",
...
ggsave("graficos/evasion/porcentaje_evasion_impuestos.png", width = 8, height = 5, dpi = 300)
...
latinobarometro %>% 
  ...
  geom_axis_flags(breaks = latinobarometro$iso3,
                  ...
                  width = 20,
                  lineheight = 2) +
  labs(title = "Porcentaje de personas que pagaron menos impuestos de lo debían",
...
latinobarometro2020 %>%
  ...
  geom_smooth(method = "lm", se = TRUE, size = .5, color = "red") +
  ggrepel::geom_text_repel(aes(label = iso3), size = 2.5, show.legend = FALSE) +
  annotate("text",
           x = 0.32, y = 0.39,  # Ajustá posición
           label = paste0("R² = ", round(r2, 3)),
           size = 3.5, hjust = 0) +
  labs(title = "Arreglo para pagar menos impuestos y estratificación objetiva",
...
ggsave("graficos/evasion/estratificacion_evasion.png", width = 8, height = 5, dpi = 300)
...
latinobarometro2020 %>%
  ...
  labs(title = "Porcentaje de personas que pagaron menos impuestos de lo debían según clase social subjetiva",
...
ggsave("graficos/evasion/porcentaje_evasion_impuestos_clase_subjetiva.png", width = 8, height = 5, dpi = 300)
...
mod1 <- export_summs(mod2_a, mod2_b, mod2_c, mod3, model.names = c("Objetivas", "Objetivas + mediadoras", "Efecto fijo países", "Sólo Argentina"), 
...
pred_estatus %>% 
  ...
  labs(
    title = "Probabilidad de evasión según estatus objetivo",
...
pred_clase %>% 
  ...
  labs(
    title = "Probabilidad de evasión según clase subjetiva",
    subtitle = "Promedio general en línea punteada roja.",
