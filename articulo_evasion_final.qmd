...
latinobarometro %>% 
  ...
  labs(
    title = "Gráfico 3. Evolución del porcentaje de personas que pagaron menos impuestos \ndel que debían",
...
latinobarometro %>% 
  ...
  geom_axis_flags(breaks = latinobarometro$iso3,
                  ...
                  width = 20,
                  lineheight = 2) +
  labs(title = "Gráfico 2. Porcentaje de personas que pagaron menos impuestos de lo debían",
...
latinobarometro2020 %>%
  ...
  labs(title = "Gráfico 5. Porcentaje de personas que pagaron menos impuestos de lo debían según \nclase social subjetiva",
...
pred_estatus <- ggpredict(mod2_c, terms = c("dim1_std[-1, 0, 1]", "pais_f"),
                          typical = c(numeric = "mean", factor = "mode"))

avg_pred <- mean(pred_estatus$predicted)

estatus_labs <- c("Bajo (-1)", "Medio (0)", "Alto (1)")
names(estatus_labs) <- c("-1", "0", "1")
...
pred_estatus %>% 
  ...
  facet_wrap(~x, labeller = labeller(x = estatus_labs)) +
...
latinobarometro %>% 
  ...
  labs(title = "Gráfico 8. Incumplimiento impositiva y PIB per cápita",
