...
latinobarometro2020 %>% 
  ...
  geom_segment(aes(x=iso3, xend=iso3, y=0, yend=promedio), color="orange", linewidth = .4) +
  ...
  geom_axis_flags(breaks = latinobarometro$iso3,
                  ...
                  lineheight = 2) +
  labs(
    # title = "Gráfico 1. Índice de estratificación social objetiva promedio",
...
ggsave("graficos/evasion/estratificacion_objetiva.png", width = 4.9, height = 3.5, dpi = 300)
...
ggsave("graficos/evasion/porcentaje_evasion_impuestos.png", width = 4.9, height = 3.5, dpi = 300)
...
latinobarometro %>% 
  ...
  geom_axis_flags(breaks = latinobarometro$iso3,
                  ...
                  lineheight = 2) +
  # labs(
  #   title = "Gráfico 2. Porcentaje de personas que conoce a alguien que pagó menos \nimpuestos de los que debía",
...
ggsave("graficos/evasion/porcentaje_evasion_impuestos_paises.png", width = 4.9, height = 3.5, dpi = 300)
...
latinobarometro2020 %>%
  ...
  ggrepel::geom_text_repel(aes(label = iso3), size = 2, show.legend = FALSE) +
  annotate("text",
...
ggsave("graficos/evasion/estratificacion_evasion.png", width = 4.9, height = 3.5, dpi = 300)
...
ggsave("graficos/evasion/porcentaje_evasion_impuestos_clase_subjetiva.png", width = 4.9, height = 7, dpi = 300)
...
pred_estatus %>% 
  ...
  facet_wrap(~x, labeller = labeller(x = estatus_labs), ncol = 3) +
...
ggsave("graficos/evasion/prediccion_estatus_objetivo.png", width = 4.9, height = 7, dpi = 300)
...
ggsave("graficos/evasion/prediccion_clase_subjetiva.png", width = 4.9, height = 7, dpi = 300)
...
latinobarometro %>% 
  ...
  ggrepel::geom_text_repel(aes(label = anio_pais), size = 2) +
  labs(
    # title = "Gráfico 8. Incumplimiento impositivo y PIB per cápita",
...
ggsave("graficos/evasion/evasion_pib.png", width = 4.9, height = 3.5, dpi = 300)
...
latinobarometro %>% 
  ...
  ggrepel::geom_text_repel(aes(label = anio_pais), size = 2) +
  labs(
    # title = "Gráfico 9. Incumplimiento impositivo e índice de Gini",
    #    subtitle = "Países de América Latina. 2010 y 2020",
...
ggsave("graficos/evasion/evasion_gini.png", width = 4.9, height = 3.5, dpi = 300)
...
latinobarometro %>% 
  ...
  geom_smooth(method = "lm", se = T, color = "red", linewidth = .5) +
    ...
    aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),  # Mostrar R²
    parse = TRUE,
    label.x = 0.7,  # Posición de la leyenda
    size = 3
  ) +
  ggrepel::geom_text_repel(aes(label = anio_pais), size = 2) +
  labs(
    # title = "Gráfico 10. Incumplimiento impositivo y % ingresos fiscales / PIB",
    #    subtitle = "Países de América Latina. 2010 y 2020",
  ...
  scale_y_continuous(labels = scales::percent_format(accuracy = 1), breaks = seq(0, .4, 0.05), limits = c(0, .4)) +
  scale_x_continuous(labels = scales::label_percent(scale = 1), breaks = seq(5, 25, 5), limits = c(5, 25))

ggsave("graficos/evasion/evasion_impuestos_pbi.png", width = 4.9, height = 3.5, dpi = 300)
...
latinobarometro %>% 
  ...
  ggrepel::geom_text_repel(aes(label = anio_pais), size = 2) +
  labs(
    # title = "Gráfico 11. Incumplimiento impositivo y % de informalidad laboral",
    #    subtitle = "Países de América Latina. 2010 y 2020",
...
ggsave("graficos/evasion/evasion_informalidad.png", width = 4.9, height = 3.5, dpi = 300)
...
latinobarometro %>% 
  ...
  ggrepel::geom_text_repel(aes(label = anio_pais), size = 2) +
  labs(
    # title = "Gráfico 12. Incumplimiento impositivo y % de clases medias",
    #    subtitle = "Países de América Latina. 2010 y 2020",
  ...
  theme(
    ...
    axis.text.y = element_text(size = 7)) +
  scale_y_continuous(labels = scales::percent_format(accuracy = 1), breaks = seq(0, .4, 0.05), limits = c(0, .4)) +
  scale_x_continuous(labels = scales::label_percent(scale = 1), breaks = seq(10, 40, 10), limits = c(10, 40))

ggsave("graficos/evasion/evasion_clases_medias.png", width = 4.9, height = 3.5, dpi = 300)
