---
title: "La desigualdad no se evade. <br> Una exploración sociológica sobre incumplimiento impositivo y estratificación social en América Latina" 
subtitle: "Premio XIII Premio Iberoamericano en Ciencias Sociales – IIS UNAM OEI <br> 
Revista Mexicana de Sociología, 2026"
author:
  - name: "Gonzalo Assusa"
...
América Latina combina dos rasgos persistentes:  

- Altos niveles de desigualdad social.
- Amplia presencia de evasión y elusión tributaria.

El artículo propone estudiar ambas dimensiones de forma articulada, 
aunque desde un enfoque no convencional.

::: {.callout-note title="Pregunta central"}
¿Cómo se relacionan la posición social, las percepciones sobre 
desigualdad y las prácticas de incumplimiento impositivo?
:::

## Punto de partida sociológico  


Los impuestos no son solo un mecanismo económico.  


También constituyen:  

-	El núcleo del lazo fiscal y vínculo entre ciudadanía y Estado  
-	Mecanismo de integración sistémica y reproducción social  
-	Espacio de disputas distributivas y por la legitimidad política  

::: {.callout-tip title="Idea clave"}
El cumplimiento tributario no depende solamente del cálculo racional, sino que está incrustado en recursos sociales, legitimidad institucional y posiciones de poder desigualmente distribuidas.
:::


## Vacancia en la literatura (I)  

::: {style="font-size: 0.80em"}
La literatura académica se ha concentrado en:  

-	El cumplimiento y su relación con la moral fiscal y la confianza institucional  
- Las preferencias redistributivas y su relación con la estructura social, sin relación con el cumplimiento  
- La informalidad como factor de evasión, focalizando la mirada sobre los sectores subalternos y construyendo un estereotipo sobre su relación con / y su concepción del Estado  

Problemas:  

- Teoría de la acción predominante (racional o normativa) y poca exploración de otras perspectivas, como la teoría de la práctica o las perspectivas estratégicas  
- Dificultades para conectar posicionamientos u opiniones con prácticas impositivas concretas  
:::


## Vacancia en la literatura (II) 

Existen pocos estudios que relacionen simultáneamente:  

1. Estratificación social  
2. Percepción de desigualdad  
3. Incumplimiento tributario  

> **Dialéctica de la evasión y la desigualdad**  
No se trata solamente de que el incumplimiento fiscal y la regresividad reproduzcan la desigualdad social.  
Sino que la desigualdad y la informalidad funcionan como factores de desgranamiento del cumplimiento impositivo.  
...
::: fragment
::: {.callout-tip title="Pregunta central - Enfoque indirecto" icon="false"}
...
reg_coef +
  labs(title ="Modelos de regresión logística. Arreglo para \npagar menos impuestos. 2020",
...
## Hallazgos y aportes (I)

- Necesidad de continuar generando evidencia empírica sobre evasión a nivel de *prácticas individuales*  
- Rediscutir el lugar de la consciencia tributaria explícita y sus efectos en el cumplimiento impositivo, particularmente en un contexto de *descontento político generalizado*  
- Las tendencias muestran la existencia de ciertos *ecosistemas fiscales* anclados en estructuras sociales diferentes, aunque es necesario seguir explorando cómo se incorporan estos factores en los modelos  

## Hallazgos y aportes (II)

- Mientras más alta la posición en la estructura social, mayores las chances de evasión, dadas las mayores condiciones para evitar pagar impuestos  
-	La clase social subjetiva y las preferencias redistributivas operan en un sentido esperado  
- Evaluación subjetiva de la desigualdad y de las políticas contra la corrupción funcionan como indicadores de malestar ciudadano que se relacionan con el incumplimiento impositivo, aunque no necesariamente en la dirección esperada  


# ¡Muchas gracias! {background-color="#00589b" style="text-align: center;"}  

{{< fa envelope >}} [gonzalo.assusa@unc.edu.ar](mailto:gonzalo.assusa@unc.edu.ar)  

{{< fa envelope >}} [jrodriguez@conicet.gov.ar](mailto:jrodriguez@conicet.gov.ar)
